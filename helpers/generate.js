...
function generateData() {
    ...
    writeToSQL("./sql/SQLinserts.sql", "ExternalLinks", externalLinks, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "URLSHORTENER", urlShortener, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "HASHTAG", hashtags, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "POST", posts, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "IncludesTag", includesTag, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "POLL", polls, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "Likes", likes, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "Replies", replies, "./sql/minified/SQLinserts.sql");
    writeToSQL("./sql/SQLinserts.sql", "Vote", votes, "./sql/minified/SQLinserts.sql");
}
