...
const Account = (props) => {
  ...
  const footer = <Footer simpleIsLogged={simpleIsLogged} editable={true} />;
            ...
            <div className="card mb-4">
              <div className="card-body">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0 editable" id="birthday">
                      {user.Birthday == null ? "N/A" : new Date(user.Birthday).toDateString()}
                    </p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0 editable" id="location">
                      {user.Location == null ? "N/A" : user.Location}
                    </p>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0 editable" id="description">
